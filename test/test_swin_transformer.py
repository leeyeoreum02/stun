import torch
from stun.model.feature_extraction import swin_transformer_96_t, swin_transformer_96_s
...
from stun.model.feature_extraction import swin_transformer_224_b, swin_transformer_224_l
...
def main():
    ...
    swinx2_b = swin_transformer_224_b()
    swinx2_l = swin_transformer_224_l()
